    ...
    <div class="cuerpo_anuncio_alu_com">       
        ...
        <div class="izqda_anuncio_alu_com">
            ...
            <div>
                ...
                <input type="text" id="cajaISBN" maxlength="45" value="<?php echo $anuncio['isbn']; ?>" readonly="readonly">
            </div>

            <div>
                <span class="propiedad_libro_alu_com"><label for="cajaTITULO">· Titulo:</label></span>
                <input type="text" id="cajaTITULO" maxlength="100" value="<?php echo $anuncio['titulo']; ?>" readonly="readonly">
            </div>

            <div>
                <span class="propiedad_libro_alu_com"><label for="cajaEDITORIAL">· Editorial:</label></span>
                <input type="text" id="cajaEDITORIAL" maxlength="45" value="<?php echo $anuncio['editorial']; ?>" readonly="readonly">
            </div>

            <div>
                <span class="propiedad_libro_alu_com"><label for="cajaPRECIO">· Precio:</label></span>
                <input type="number" step="0.01" class="cajaPrecio_alu_com" id="cajaPRECIO" value="<?php echo $anuncio['precio']; ?>" readonly="readonly"> €.
            </div>

            <div>
                <span class="propiedad_libro_alu_com"><label for="cajaESTADO">· Estado:</label></span><br>
                <textarea class="caja_estado_alu_com" name="cajaESTADO" id="cajaESTADO" maxlength="499" value="" placeholder="" required="required" readonly="readonly"><?php echo quita_br_a_saltos_de_linea($anuncio['estado']); ?></textarea>
                <!--<input type="text" id="cajaESTADO" maxlength="300" value="<?php echo $anuncio['estado']; ?>" readonly="readonly">-->
            </div>
